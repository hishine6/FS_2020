...
Member::Member(const string _ID, const string _Password, const string _Name, const string _Email, const string _Address, const char _Birthday[10], const char _Class) {
	this->ID = _ID;
